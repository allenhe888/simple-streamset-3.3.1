...
public class Mounts extends VaultEndpoint {
  private static final Logger LOG = LoggerFactory.getLogger(Mounts.class);

  public Mounts(
      VaultConfiguration conf, HttpTransport transport
  ...
  public boolean mount(String path, String type, String description) throws VaultException {
    return mount(path, type, description, null);
  }

  public boolean mount(String path, String type) throws VaultException {
    return mount(path, type, null, null);
  }
}
