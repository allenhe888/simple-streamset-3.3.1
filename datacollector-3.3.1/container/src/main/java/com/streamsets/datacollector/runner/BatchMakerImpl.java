...
public class BatchMakerImpl implements BatchMaker {
  ...
  private long batchMarkerStart=0L;
  private long initClone=0L;
  @Override
  public void addRecord(Record record, String... lanes) {
    batchMarkerStart = System.nanoTime();
...
//    StaticCounter.getInstance().addThreadTimeAndBatchCount(StaticCounter.Key.PIPELINE_Maker_GetRecord,System.nanoTime() -batchMarkerStart);


    initClone = System.nanoTime();
    ...
    StaticCounter.getInstance().addThreadTimeAndBatchCount(StaticCounter.Key.PIPELINE_Maker_InitClone,System.nanoTime() -initClone);
    ...
    StaticCounter.getInstance().addThreadTimeAndBatchCount(StaticCounter.Key.PIPELINE_Batch_Maker_AllClone,System.nanoTime() -batchMarkerStart);
