...
//      StaticCounter.getInstance().addThreadTimeAndBatchCount(StaticCounter.Key.PIPELINE_RUN_SOURCE_KEY,System.nanoTime() -startOrigin);

      startProcessors = System.nanoTime();
      try {
...
//      StaticCounter.getInstance().addThreadTimeAndBatchCount(StaticCounter.Key.PIPELINE_RUN_PROCESSORS_KEY,System.nanoTime() -startProcessors);

//      StaticCounter.getInstance().addThreadTimeAndBatchCount(StaticCounter.Key.PIPELINE_RUN_ONE_BATCH_KEY,System.nanoTime() -startBatch);
//      StaticCounter.getInstance().printTimeAndClean();
    }
  }
